...
describe('Game Scenarios', () => {
  describe('Famous Games', () => {
    it('should play the Immortal Game', () => {
      ...
      const moves = [
        ...
        { from: 'f2', to: 'f4' }, { from: 'e5', to: 'f4' },
        { from: 'f1', to: 'c4' }, { from: 'd8', to: 'h4' },
        { from: 'e1', to: 'f1' }, { from: 'b7', to: 'b5' },
        { from: 'c4', to: 'b5' }, { from: 'g8', to: 'f6' },
        { from: 'g1', to: 'f3' }, { from: 'h4', to: 'h6' },
      ];
  ...
  describe('Checkmate Patterns', () => {
    it('should execute back rank mate', () => {
      ...
      // Set up position
      game.getBoard().clear();
      for (let square of ['a1', 'a2', 'a3', 'a4', 'a5', 'a6', 'a7', 'a8',
  ...
  describe('Stalemate Scenarios', () => {
    it('should have stalemate detection capability', () => {
      ...
      expect(['active', 'check', 'checkmate', 'stalemate', 'draw', 
