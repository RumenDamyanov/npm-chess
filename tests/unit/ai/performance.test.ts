...
describe('AI Performance Benchmarks', () => {
  ...
  describe('MinimaxAI Performance', () => {
    ...
    it('medium difficulty should complete in reasonable time', async () => {
      ...
      console.log(`Medium (depth ${analysis.depth}): ${elapsed}ms, ${analysis.nodesEvaluated} nodes`);
    });
  ...
  describe('Comparative Performance', () => {
    it('should compare Random vs Minimax complexity', async () => {
      ...
      console.log(`Random nodes: ${randomAnalysis.nodesEvaluated}, Minimax nodes: ${minimaxAnalysis.nodesEvaluated}`);
